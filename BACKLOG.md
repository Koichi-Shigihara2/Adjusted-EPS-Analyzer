...
### [RECESSION-SCORE-TRIPLE-CALC-1] RECESSION RISK SCOREの3計算式併存・フェーズ境界25/30の3箇所不一致 — ①②は解消済み、③は`[[MACRO-COMPUTE-DUP-1]]`との重複を発見・対応方針を要判断
...
#### 着手条件
対応方針（案A/B/Cいずれか）をKoichiさんと確定してから着手する。
今回は調査・記録のみで実装しない。
